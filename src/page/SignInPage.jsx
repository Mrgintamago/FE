      ...
      >
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-2 group cursor-pointer">
            <input
              ...
              className="h-4 w-4 cursor-pointer accent-[#1DC071] rounded border-gray-300 focus:ring-2 focus:ring-[#1DC071] transition-all"
            />
            <label 
              htmlFor="rememberMe" 
          ...
          <Link
            to="/forgot-password"
            className="text-sm text-[#1DC071] font-medium hover:text-[#16a05a] hover:underline transition-all"
          >
            Quên mật khẩu?
          </Link>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full bg-white border-2 border-gray-300 text-gray-700 rounded-lg px-4 py-3 flex items-center justify-center gap-3 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 font-medium text-sm shadow-sm hover:shadow-md"
          >
